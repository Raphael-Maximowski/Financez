...
onMounted(() => {
  const timeInterval = setTimeRangeBasedInActualDate(new Date(), 'year')
  userDataManegement.setTransactionsTimeRange(timeInterval)
  userDataManegement.setDashBoardData()
})
